    ...
    <div className="flex min-h-dvh">
      ...
      {bukaDrawer && (
        <div className="fixed inset-0 z-40 lg:hidden">
          ...
          />
          <aside className="absolute left-0 top-0 h-full w-64 border-r border-gray-200 bg-white dark:border-zinc-700 dark:bg-zinc-900">
            <div className="flex h-14 items-center justify-between border-b border-gray-200 px-4 dark:border-zinc-700">
              <span className="text-sm font-semibold text-gray-900 dark:text-gray-50">Menu</span>
              <button
                onClick={() => setBukaDrawer(false)}
      ...
      <div className="flex min-w-0 flex-1 flex-col">
        <header className="sticky top-0 z-30 flex h-14 items-center gap-3 border-b border-gray-200 bg-white px-4 dark:border-zinc-700 dark:bg-zinc-900">
          <button
            onClick={() => setBukaDrawer(true)}
            className="rounded-lg p-2 text-gray-700 hover:bg-gray-100 lg:hidden dark:text-gray-300 dark:hover:bg-zinc-700"
          ...
          <button
            onClick={keluar}
            className="flex min-h-11 items-center gap-1.5 rounded-lg px-2.5 text-sm font-medium text-gray-700 hover:bg-gray-100 dark:text-gray-300 dark:hover:bg-zinc-700"
          >
